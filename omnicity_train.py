...
def main():
    ...
    train_dataset = OmniCityDataset(args.train_data_file, args.text_prompt, image_size, args.drop_prompt_ratio)
    valid_dataset = OmniCityDataset(args.valid_data_file, args.text_prompt, image_size)
    ...
    tb_logger = TensorBoardLogger(result_dir)
    log_images_kwargs = {
